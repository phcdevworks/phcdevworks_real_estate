...
Gem::Specification.new do |spec|
    ...
    # Theme Dependencies
    spec.add_dependency "phcthemes_admin_panel_pack", "~> 1.5"
    spec.add_dependency "phcthemes_web_theme_pack", "~> 1.3"

    # Helper Dependencies
    spec.add_dependency "phcdevworks_core", "~> 1.0.6"
    spec.add_dependency "phcdevworks_active_menus", "~> 1.0.6"
    spec.add_dependency "phcdevworks_notifications", "~> 1.0.6"
    ...
    spec.add_dependency "phcdevworks_accounts", "~> 1.5"
